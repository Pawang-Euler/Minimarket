...
public class AssociationRuleMining {
	...
	public static void main(String[] args) throws Exception {
		...
		String filePath = "/media/reyrizki/DATA/Programming/Association_Rule_Mining_using_Trie-master/AssociationRule/src/data/custom.arff";
	...
	public Instances readDataSet(String filePath) throws Exception{
		...
		// DataSource input = new DataSource("supermarket.arff");
